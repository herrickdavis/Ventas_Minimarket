"""
Django settings for minimarket_api project.
...
SECRET_KEY = 'django-insecure-ltd_(6ksf^=sg4%+wvxk&f#hf(gm34=7*d66vx*&!&q)l%bji4'
...
#condicionado para permisivo en desarrollo HDM
